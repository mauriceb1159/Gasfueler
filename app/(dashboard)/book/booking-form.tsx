              ...
              {visibleStations.map((station) => (
                ...
                >
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 text-xs text-slate-500">
                    ...
                    <span>•</span>
                    <span>{station.serviceSlots.length} open slots</span>
                    {station.supportsSnacks ? (
                      <>
                        <span>•</span>
                        <span>Snack pickup available</span>
                      </>
                    ) : null}
                  </div>
                </button>
...
export function EmptyBookingState() {
  return (
    <div className="rounded-[1.75rem] border border-dashed border-orange-200 bg-orange-50/70 p-8 text-slate-700">
