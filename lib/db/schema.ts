...
export const users = pgTable('users', {
  ...
  supabaseAuthUserId: text('supabase_auth_user_id').unique(),
...
export const fuelRequests = pgTable('fuel_requests', {
  ...
  gasCapBeforePhotoUrl: text('gas_cap_before_photo_url'),
  gasCapAfterPhotoUrl: text('gas_cap_after_photo_url'),
  pumpPhotoUrl: text('pump_photo_url'),
  gasCapPhotoUrl: text('gas_cap_photo_url'),
  receiptPhotoUrl: text('receipt_photo_url'),
  tireFrontLeftPhotoUrl: text('tire_front_left_photo_url'),
  tireFrontRightPhotoUrl: text('tire_front_right_photo_url'),
  tireRearLeftPhotoUrl: text('tire_rear_left_photo_url'),
  tireRearRightPhotoUrl: text('tire_rear_right_photo_url'),
